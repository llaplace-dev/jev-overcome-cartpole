#!/usr/bin/env python3
"""Run a safety-aware CartPole agent with Jev through TypeSafe's API.

This starts from v1 and adds explicit action-direction semantics, numeric
warning zones, the 500-step objective, and a control priority order.
"""
...
def _make_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Run the safety-aware CartPole prompt derived from v1 "
